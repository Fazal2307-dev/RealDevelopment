...
const App = () => {
  ...
  return (
    <div className='parent'>
      {carrerPage.map(function(elem,idx){
        return <div key = {idx}>
          <Card company={elem.companyName} brandLogo={elem.brandLogo} date = {elem.datePosted} post = {elem.post} tag1={elem.tag1} tag2 = {elem.tag2} payment={elem.pay} location={elem.location}/>
        </div>
      })}
    </div>
  )
